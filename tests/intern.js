define([
    ...
    // todo: figure out how to get this running on Saucelabs / Selenium
    if (has('host-browser')) {
        suites.push('tests/unit/node');
    }
    return {
        //
        runType: 'runner',
...
//          { browserName: 'safari', version: '6', platform: 'OS X 10.8' },
        ...
        loader: {
            ...
            packages: [ {name: 'jpanel', location: '/src/js/exports/jpanel'} ]
        },
        ...
        functionalSuites: [ 'tests/functional/transition' ],
